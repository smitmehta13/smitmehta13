    ...
    const PROJECTS = [
        ...
        },
        {
            ...
            description: `
                ...
                <b>What I developed?</b> <br/>
                The <a href="https://psycare.ca">psycare.ca</a> website frontend was done by me. Besides that, I also implemented our emailing service server which can be found <a href="https://github.com/lnogueir/psyfy-emailer">here</a>, which served the purpose of communication between the application and our subscribed therapists. <br/><br/>
                <b>Challenges:</b> <br/>
        ...
        },
        {
            ...
            description: `
                ...
                Our team divided the work as following: <a href=https://github.com/michaelfromyeg>Michael</a> was responsible for the algorithm to generate common topics from submitted note files and merge them, me and <a href="https://github.com/n-young">Nick</a> were responsible for creation of front and backend together. <br/> <br/>
        ...
        },
        {
            ...
            description: `
                ...
                • Web crawler to collect job postings from websites such as <a href="https:/indeed.com">indeed</a> and using scikit learn, filtered the postings based on machine learning model which judged which were considered entry level jobs and which weren't.
                <br/><br/>
                <b>In order to?</b><br/>
