...
%----------------------------------------------------------------------------------------
\vspace{-.05cm}
\begin{rSubsection}{\textbf{Languages} | \normalfont{C++, Python, C, JavaScript, Go, Java, TypeScript, HTML, CSS}{}}{}{}

\end{rSubsection}
\vspace{-.20cm}
\begin{rSubsection}{\textbf{Tech} | \normalfont{Docker, Git, React, MySQL, AWS, WebRTC, Node.js, MongoDB, Redis, Flask, Nginx, Jenkins}{}}{}{}
...
\vspace{-.1cm}
\begin{rSubsection}{\textbf{Software Engineering Intern | Coursera} }{\textcolor{gray}{\small Canada (Remote) | Jan 2022 - Present}}{}

    \begin{bulletpoints}
        \vspace{-.10cm}
        \item Working on the Content Platform \& Ingestion API team to support and enrich the course experience of +90 million registered students in the platform.
        \vspace{-.10cm}
    \end{bulletpoints}
\end{rSubsection}
