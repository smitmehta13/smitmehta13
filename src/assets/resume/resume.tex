...
\begin{rSubsection}{\textbf{Software Developer Intern | Google}}{\textcolor{gray}{\small Waterloo, Canada | May 2022 - Present}}{}
        ...
        \begin{bulletpoints}
            \vspace{-.10cm}
            \item Currently, contributing to the Go SDK for the Google Cloud Health Care API in the Apache Beam open-source project.
             \vspace{-.10cm}
        \end{bulletpoints}
\end{rSubsection}
\begin{rSubsection}{\textbf{Software Engineer Intern | Coursera} }{\textcolor{gray}{\small Canada (Remote) | Jan 2022 - April 2022}}{}
    ...
    \begin{bulletpoints}
        \vspace{-.10cm}
        \item Wrote and maintained scalable Spring Boot gRPC services to efficiently load and store course content such as videos, readings, and quizzes, impacting \textasciitilde 100 million registered users.
        \vspace{-.13cm}
